...
echo $dbmsg;
	...
	$urltrimmed = remove_query_arg( array('taction', 'id') );
		...
		$html .= '<tr id="'.$currentform->id.'">
				...
				<th scope="col" class="wpyelp_upgrade_needed manage-column"><b>'.$currentform->template_type.'</b></th>
	...
	<table class="wpyelp_margin10 form-table ">
		<tbody>
			<tr class="wpyelp_row">
				...
				<td>
					<input id="wpyelp_template_title" data-custom="custom" type="text" name="wpyelp_template_title" placeholder="" value="<?php echo $currenttemplate->title; ?>" required>
					<p class="description">
			...
			<tr class="wpyelp_row">
				...
				<td><div id="divtemplatestyles">
					...
					<label for="wpyelp_template_type1-radio"><?php _e('Post or Page', 'wp-fb-reviews'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<label for="wpyelp_template_type2-radio"><?php _e('Widget Area', 'wp-fb-reviews'); ?></label>
					</div>
					<p class="description">
...
<tr class="wpyelp_row">
				...
				?>
								...
								<div class="wprevpre_temp_label_row">
									<input id="wpyelp_template_misc_bradius" type="number" min="0" name="wpyelp_template_misc_bradius" placeholder="" value="<?php echo $template_misc_array['bradius']; ?>" style="width: 4em">
								</div>
								<div class="wprevpre_temp_label_row">
									<input type="text" data-alpha="true" value="<?php echo $template_misc_array['bgcolor1']; ?>" name="wpyelp_template_misc_bgcolor1" id="wpyelp_template_misc_bgcolor1" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_bgcolor2">
									<input type="text" data-alpha="true" value="<?php echo $template_misc_array['bgcolor2']; ?>" name="wpyelp_template_misc_bgcolor2" id="wpyelp_template_misc_bgcolor2" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row">
									<input type="text" value="<?php echo $template_misc_array['tcolor1']; ?>" name="wpyelp_template_misc_tcolor1" id="wpyelp_template_misc_tcolor1" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row">
									<input type="text" value="<?php echo $template_misc_array['tcolor2']; ?>" name="wpyelp_template_misc_tcolor2" id="wpyelp_template_misc_tcolor2" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_tcolor3">
									<input type="text" value="<?php echo $template_misc_array['tcolor3']; ?>" name="wpyelp_template_misc_tcolor3" id="wpyelp_template_misc_tcolor3" class="my-color-field" />
								</div>
								
								
								<a id="wpyelp_pre_resetbtn" class="button"><?php _e('Reset Colors', 'wp-review-slider-pro'); ?></a>
							</div>
						  </div>
						  <div class="w3_wprs-col s6" id="wpyelp_template_preview">

						  </div>
					</div>
					<p class="description">
					<?php _e('More styles available in <a href="?page=wp_yelp-get_pro">Pro Version</a> of plugin!', 'wp-fb-reviews'); ?></p>
				</td>
			</tr>
			<tr class="wpyelp_row">
				<th scope="row">
				...
				<td>
					<textarea name="wpyelp_template_css" id="wpyelp_template_css" cols="50" rows="4"><?php echo $currenttemplate->template_css; ?></textarea>
					<p class="description">
					<?php _e('Enter custom CSS code to change the look of the template when being displayed. ex: </br>.wpyelp_t1_outer_div {
						background: #e4e4e4;
					}', 'wp-fb-reviews'); ?></p>
				</td>
			</tr>			
			...
			<tr class="wpyelp_row">
				...
				<td><div class="divtemplatestyles">
					<label for="wpyelp_t_display_num"><?php _e('How many per a row?', 'wp-fb-reviews'); ?></label>
					...
					<label for="wpyelp_t_display_num_rows"><?php _e('How many total rows?', 'wp-fb-reviews'); ?></label>
					<input id="wpyelp_t_display_num_rows" type="number" name="wpyelp_t_display_num_rows" placeholder="" value="<?php if($currenttemplate->display_num_rows>0){echo $currenttemplate->display_num_rows;} else {echo "1";}?>">
			...
			<tr class="wpyelp_row">
				...
				<td>
					<div class="divtemplatestyles">
						<label for="wpyelp_t_createslider"><?php _e('Display reviews in slider?', 'wp-fb-reviews'); ?></label>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label for="wpyelp_t_display_num_rows"><?php _e('How many total slides?', 'wp-fb-reviews'); ?></label>
			...
			<tr>
				<td class="notice updated " colspan="2" style="border-left: 4px solid #d6d6d6;">
					<p><strong><?php _e('Upgrade to the Pro Version of this plugin to access more super cool settings! <a href="#TB_inline?tempnum=1&inlineId=mythickboxid&height=650&width=1030" class="thickbox">(Screenshot)</a> Get the Pro Version <a href="?page=wp_yelp-get_pro">here</a>!', 'wp-fb-reviews'); ?></strong></p>
				</td>
			</tr>
	...
	<input type="submit" name="wpyelp_submittemplatebtn" id="wpyelp_submittemplatebtn" class="button button-primary" value="<?php _e('Save Template', 'wp-fb-reviews'); ?>">
