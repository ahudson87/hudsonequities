...
<div class="w3_wprs-row">
    ...
    text-decoration: none;
							...
							<div class="w3_wprs-col s4">
							  <div class="w3_wprs-col">							
							  <div class="wpyelp_t1_DIV_1">									
							  <div class="wpyelp_t1_DIV_2 wprev_preview_bg1 wprev_preview_bradius" style="border-radius: 0px; background: rgb(253, 253, 253);">										<p class="wpyelp_t1_P_3 wprev_preview_tcolor1" style="color: rgb(85, 85, 85);">											<span class="wpyelp_star_imgs"><img src="https://ljapps.com/wp-content/plugins/wp-review-slider-pro-premium/public/partials/imgs/stars_5_yellow.png" alt="">&nbsp;&nbsp;</span>Great product, great support! Love this product and the support received has been amazing and fast.</p>									</div><span class="wpyelp_t1_A_8"><img src="https://s3-media3.fl.yelpcdn.com/photo/9Fs55PxyEqobFBQwzmu_wg/120s.jpg" alt="thumb" class="wpyelp_t1_IMG_4"></span> <span class="wpyelp_t1_SPAN_5 wprev_preview_tcolor2" style="color: rgb(85, 85, 85);">Russ Kemp<br>Owner, <a href="https://www.russkempphotography.com" target="_blank">Russ Kemp Photography </a><br><span id="wprev_showdate"></span> </span>								</div>								
							  </div>
							</div>
						  <div class="w3_wprs-col s4">
							  <div class="w3_wprs-col">							
							  <div class="wpyelp_t1_DIV_1">
							  <div class="wpyelp_t1_DIV_2 wprev_preview_bg1 wprev_preview_bradius" style="border-radius: 0px; background: rgb(253, 253, 253);">										<p class="wpyelp_t1_P_3 wprev_preview_tcolor1" style="color: rgb(85, 85, 85);">											<span class="wpyelp_star_imgs"><img src="https://ljapps.com/wp-content/plugins/wp-review-slider-pro-premium/public/partials/imgs/stars_5_yellow.png" alt="">&nbsp;&nbsp;</span>Exactly what I needed. Excellent support as well.		</p>									</div><span class="wpyelp_t1_A_8"><img src="https://www.gravatar.com/avatar/950af451288353b2525a0064e4e95efa?size=75&default=https%3A%2F%2Fdashboard.freemius.com%2Fassets%2Fimg%2Ffs%2Fprofile-pics%2Fprofile-pic-2.png" alt="thumb" class="wpyelp_t1_IMG_4"></span> <span class="wpyelp_t1_SPAN_5 wprev_preview_tcolor2" style="color: rgb(85, 85, 85);">C.J. Ware<br><span id="wprev_showdate"></span> </span>								</div>								
							  </div>
						  </div>
					</div>
					</br>
