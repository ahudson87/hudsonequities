...
class wpyelp_Widget extends WP_Widget {

  // Set up the widget name and description.
  public function __construct() {
    $widget_options = array( 'classname' => 'wpyelp_widget', 'description' => 'Widget for WP Yelp Review Slider Plugin. Allows you to display your reviews in your widget areas.' );
    parent::__construct( 'wpyelp_widget', 'WP Yelp Review Slider', $widget_options );
  }
  ...
  public function widget( $args, $instance ) {
	...
	if($templatedetails){
		...
		include plugin_dir_path( __FILE__ ) . 'partials/wp-yelp-review-slider-public-display-widget.php';
...
// Register the widget.
function wpyelp_register_widget() { 
  register_widget( 'wpyelp_Widget' );
}
add_action( 'widgets_init', 'wpyelp_register_widget' );
