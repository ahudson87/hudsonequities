...
if ( ! defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	exit;
		...
		// Leave no trail wp-yelp-review-slider_version widget_wpyelp_widget
		$option1 = 'wp-yelp-review-slider_version';
		$option2 = 'wpyelp_yelp_settings';
		$option3 = 'widget_wpyelp_widget';
		$option4 = 'wpyelp_options';
